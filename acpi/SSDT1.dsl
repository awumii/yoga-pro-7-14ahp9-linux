...
{
    External (\_SB.PCI0.LPC0.EC0.ECMT, MutexObj)
    External (\_SB.PCI0.LPC0.EC0.ECAV, IntObj)
    ...
    Scope (\_SB)
    {
        Device (UBTC)
        {
            ...
            Method (ECWR, 0, Serialized)
            {
                ...
                If ((Acquire (\_SB.PCI0.LPC0.EC0.ECMT, 0xFFFF) == Zero))
                {
                    If (\_SB.PCI0.LPC0.EC0.ECAV)
                    {
                        \_SB.PCI0.LPC0.EC0.MGO0 = MGO0
                        \_SB.PCI0.LPC0.EC0.MGO1 = MGO1
                        \_SB.PCI0.LPC0.EC0.MGO2 = MGO2
                        \_SB.PCI0.LPC0.EC0.MGO3 = MGO3
                        \_SB.PCI0.LPC0.EC0.MGO4 = MGO4
                        \_SB.PCI0.LPC0.EC0.MGO5 = MGO5
                        \_SB.PCI0.LPC0.EC0.MGO6 = MGO6
                        \_SB.PCI0.LPC0.EC0.MGO7 = MGO7
                        \_SB.PCI0.LPC0.EC0.MGO8 = MGO8
                        \_SB.PCI0.LPC0.EC0.MGO9 = MGO9
                        \_SB.PCI0.LPC0.EC0.MGOA = MGOA
                        \_SB.PCI0.LPC0.EC0.MGOB = MGOB
                        \_SB.PCI0.LPC0.EC0.MGOC = MGOC
                        \_SB.PCI0.LPC0.EC0.MGOD = MGOD
                        \_SB.PCI0.LPC0.EC0.MGOE = MGOE
                        \_SB.PCI0.LPC0.EC0.MGOF = MGOF
                        \_SB.PCI0.LPC0.EC0.CTL0 = CTL0
                        \_SB.PCI0.LPC0.EC0.CTL1 = CTL1
                        \_SB.PCI0.LPC0.EC0.CTL2 = CTL2
                        \_SB.PCI0.LPC0.EC0.CTL3 = CTL3
                        \_SB.PCI0.LPC0.EC0.CTL4 = CTL4
                        \_SB.PCI0.LPC0.EC0.CTL5 = CTL5
                        \_SB.PCI0.LPC0.EC0.CTL6 = CTL6
                        \_SB.PCI0.LPC0.EC0.CTL7 = CTL7
            ...
            Method (ECRD, 0, Serialized)
            {
                ...
                If ((Acquire (\_SB.PCI0.LPC0.EC0.ECMT, 0xFFFF) == Zero))
                {
                    If (\_SB.PCI0.LPC0.EC0.ECAV)
                    {
                        ...
                        VER1 = \_SB.PCI0.LPC0.EC0.VER1
                        VER2 = \_SB.PCI0.LPC0.EC0.VER2
                        RSV1 = \_SB.PCI0.LPC0.EC0.RSV1
                        RSV2 = \_SB.PCI0.LPC0.EC0.RSV2
